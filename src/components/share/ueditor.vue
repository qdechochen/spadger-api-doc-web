<template>
  <script :id="randomId" name="content" style="box-sizing:border-box;" type="text/plain"></script>
</template>
  ...
  methods: {
    insertScriptTag() {
      ...
      if (editorScriptTag === null) {
        ...
        head.appendChild(configScriptTag);
        head.appendChild(editorScriptTag);
      }
      // 等待代码加载完成后初始化编辑器
